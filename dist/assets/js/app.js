...
(0, _jquery2.default)(document).ready(function () {
    ...
    (0, _jquery2.default)('.hamburger-menu').on('click', function () {
        (0, _jquery2.default)(this).toggleClass('animate');
    ...
    var menu_items = [{ offset: 0, id: 'home', target: "body" }, { id: 'about', target: "About" }, { id: 'services', target: "Services" }, { id: 'works', target: "Works" }, { id: 'contacts', target: "Contact" }];
    ...
    (0, _jquery2.default)('.firstSlider').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: true,
        prevArrow: (0, _jquery2.default)('.slick-prev.first'),
        nextArrow: (0, _jquery2.default)('.slick-next.first'),
        dots: true,
        infinite: true,
        dotsClass: 'slick-dots'
    });
    (0, _jquery2.default)('.secondSlider').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        arrows: true,
        prevArrow: (0, _jquery2.default)('.slick-prev.second'),
        nextArrow: (0, _jquery2.default)('.slick-next.second'),
        dots: false,
        infinite: true,
        dotsClass: 'slick-dots',
        swipe: true,
    ...
    (0, _jquery2.default)(window).scroll(function () {
        if ((0, _jquery2.default)(this).scrollTop() > 1000) {
            ...
            (0, _jquery2.default)('.arrow-top').fadeOut();
        }
    });

    (0, _jquery2.default)('.arrow-top').click(function () {
        (0, _jquery2.default)('html, body').animate({ scrollTop: 0 }, 1000);
        return false;
    });
});
//----------------------------------------Google Maps------------------------------------------
